...
from dsa.binary_tree.preorder_traversal_recursive import Solution as S1
...
class TestInorderTraversal(TestCase):
    ...
    def test_preorder_traversal_recursive2(self):
    ...
    def test_preorder_traversal_recursive3(self):
    ...
    def test_preorder_traversal_recursive4(self):
